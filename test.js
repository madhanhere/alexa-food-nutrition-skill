...
var event = {
    session: {
        ...
        application: {
            applicationId: 'amzn1.ask.skill.f7d863be-2ee9-4c79-8977-6f20538cd8ff'
        }
    },
    version: '1.0',
    request: {
...
describe('All intents', function () {
    ...
    for (var key in expResults) {
        ...
        describe(`Test GetNutritionInfo ${key}`, function () {
            ...
            before(function (done) {
                ...
                event.request.intent.name = 'GetNutritionCaloriesInfo';
    ...
    describe(`Test GetNutritionCaloriesInfo empty slot`, function () {
    ...
    describe(`Test GetNutritionProteinInfo empty slot`, function () {
        before(function (done) {
            event.request.intent = {};
            event.session.attributes = {};
            event.request.type = 'IntentRequest';
            event.request.intent.name = 'GetNutritionProteinInfo';
            event.request.intent.slots = {};
            ctx.done = done;
            lambdaToTest.handler(event, ctx);
        });
    ...
    describe(`Test GetNutritionFatInfo empty slot`, function () {

        before(function (done) {
            event.request.intent = {};
            event.session.attributes = {};
            event.request.type = 'IntentRequest';
            event.request.intent.name = 'GetNutritionFatInfo';
            event.request.intent.slots = {};
            ctx.done = done;
            lambdaToTest.handler(event, ctx);
        });
